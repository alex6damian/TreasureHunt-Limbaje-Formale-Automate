...
c=cs112_passer.load_file("input.cfg") # citirea fisierului
...
mort=0 # initializare starea jucatorului
...
for s in string: # parcurgerea stringului
    for t in transitions: # parcurgerea tranzitiilor
        if t[0] == curent and s==t[1]: # verificare daca tranzitia este posibila
            ...
            if curent=='c3': # verificare daca am ajuns la camera 3
                items[1]=1 # setare sabie
            if curent=='c6': # verificare daca am ajuns la camera 6
